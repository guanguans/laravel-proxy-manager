 ...
 * @method static void                                                      singletonNoopVirtualProxy(string $className, ?\Closure $concrete = null)
 * @method static void                                                      bindNoopVirtualProxy(string $className, ?\Closure $concrete = null, $shared = false)
 *
